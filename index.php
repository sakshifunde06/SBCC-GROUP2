    ...
    <footer class="page-footer">
      ...
      <div class="footer-nav">
        <div class="container clearfix">
          ...
          <div class="footer-nav__col footer-nav__col--contacts">
            ...
            Head Office: Sajivaninagar.<br>
            Sinner Nashik.
          </address>
            <div class="phone">
              Telephone:
              <a class="phone__number" href="9875785050">9875785050</a>
            </div>
            <div class="email">
              Email:
              <a href="masteragroscience@gmail.com" class="email__addr">masteragroscience@gmail.com</a>
            </div>
          </div>
      ...
      <div class="page-footer__subline">
        <div class="container clearfix">
          ...
          <div class="copyright">
            &copy; <?php echo date("Y");?> Master Agro Science&trade;
          </div>

          <div class="developer">
            Developed by  Sbcc group_2
          </div>

          <div class="designby">
            Design by  Sbcc group_2
          </div>
